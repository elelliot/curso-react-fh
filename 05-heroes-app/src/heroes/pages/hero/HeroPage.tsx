...
export const HeroPage = () => {
  ...
  const {
    data: superheroData,
    isLoading: isLoadingHeroData,
    isError,
  } = useQuery({
    queryKey: ["hero-profile", idSlug],
    queryFn: () => getHero(idSlug),
  });

  // Yo juraba que estos tipos de returns debian hacerse despues de toda logica, pero veo que si se puede @_@, o por lo menos quiza sea mala practica
  ...
  if (isError || !superheroData)
    return (
      <div>
        <h2>Error: Superheroe no encontrado, por favor intente de nuevo</h2>
      </div>
    );
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="relative">
              <img
                ...
                width={200}
                height={200}
                className="max-h-52 rounded-full border-4 border-white/20 shadow-2xl"
              />
