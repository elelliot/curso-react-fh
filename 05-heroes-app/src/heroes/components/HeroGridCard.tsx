  ...
  return (
    <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-gray-50">
      <div className="relative h-64">
        ...
        <Badge
          className={`absolute top-3 right-3 text-xs  text-white ${hero.universe === "DC" ? "bg-blue-600" : "bg-red-600"}`}
        >
          {hero.universe}
        </Badge>
      ...
      <CardHeader className="py-5 z-10 bg-gray-100/50 backdrop-blur-sm relative top-1 group-hover:top-[-10px] transition-all duration-300">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap gap-1">
            ...
            {/* Y si nos pasamos de 3, entonces simplemente retornamos el X More (Powers - 3) */}
